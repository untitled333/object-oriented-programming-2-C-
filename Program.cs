...
class CashDesk
{
    ...
    public static string LogFilePath { get; } = @"E:\Unik\Proga 1\лаби 1.2\FullCinemaLog.txt";
...
class Program
{
    static void Main()
    {
        ...
        var film2 = new VariousAdultFilms("Requiem for a dream", 150, 102, "\rHorror/Drama");
        var film3 = new VariousAdultFilms("Titanik", 150, 195, "\r\nRomance/Adventure");
        var film4 = new VariousAdultFilms("Five Feet Apart", 150, 117, "\r\nRomance/Drama");
